<template>
	<view class="uni-navbar" :class="{'uni-dark':dark, 'uni-nvue-fixed': fixed}">
		<view class="uni-navbar__content backGroundImage" :class="{ 'uni-navbar--fixed': fixed, 'uni-navbar--shadow': shadow, 'uni-navbar--border': border }">
			<status-bar v-if="statusBar" />
			<view :style="{ color: themeColor, height:navbarHeight}"
				...
				<view @tap="onClickLeft" class="uni-navbar__header-btns uni-navbar__header-btns-left"
					...
					<slot name="left">
						...
						<view v-if="leftType===2">
							<image src="/static/img/back.png" class="back" @click="back"></image>
						</view>
					</slot>
				</view>
...
<style lang="scss" scoped>
	...
	.backGroundImage{
		height: $nav-height;
    background-image: linear-gradient(90deg, rgb(205, 1, 3), rgb(246, 72, 65));
		box-sizing: border-box;
	}
</style>
